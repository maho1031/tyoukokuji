...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="wp-content/themes/sample/style.css">
...
<body>
     ...
     <header class="l-header js-float-menu">
         <div class="p-header">
             <div class="p-header__head">
                ...
                <h1 class="p-header__logo"><a href="#" class="p-header__link">長谷寺</a></h1>
             </div>
                ...
                <div class="p-news__inner">
                    ...
                    <div class="p-news__btncontainer u-mt30">
                        <div class="p-news__btn">
                            <a href="news.html" class="c-btn c-btn__news">一覧はこちら</a>
             ...
             <div class="p-about__header appear down">
                ...
                <div class="p-about__inner">
                        ...
                        <div class="p-about__text u-mt30">
                            ...
                            <div class="p-news__btncontainer u-mt30">
                                <div class="p-news__btn">
                                    <a href="http://localhost:8888/tyoukokuji/about.html" class="c-btn c-btn__news">詳しくはこちら</a>
            ...
            <div class="p-event__inner">
                <ul class="p-event__main">
                    ...
                    <li class="p-event__item u-mt16">
                        <p>
                            <span class="p-event__date">2月8日</span><br>
                            <span class="p-event__title">法話会</span>
                        </p>
                    </li>
            ...
            <!-- Slider main container -->
                    <div class="swiper-container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img src="images/about.jpg" alt=""></div>
                        </div>
     ...
     <!-- footer -->
     <footer class="l-footer u-mt120">
         <div class="p-footer">
             <div class="p-footer__inner">
                <div class="p-footer__header u-mb16">
                    <p class="p-footer__title">曹洞宗</p>
                    <h1 class="p-header__logo">長谷寺</h1>
                 </div>
                 <div class="p-footer__body">
                    <div class="p-footer__address">
                        <p>〒990-0892 山形県山形市中野96</p>
                    </div>
                    <div class="p-footer__copyright u-mt30">
                        <p>
                            &copy;Tyoukokuji. All rights reserved.
                        </p>
                    </div>
                 </div>
             </div>
...
<script src="wp-content/themes/sample/js/libs/swiper.js"></script>
<script src="p-content/themes/sample/js/libs/scroll.js"></script>
<script src="p-content/themes/sample/js/libs/mobile-menu.js"></script>
<script src="p-content/themes/sample/js/libs/tab.js"></script>
<script src="p-content/themes/sample/js/libs/fixfooter.js"></script>
<script src="p-content/themes/sample/js/main.js"></script>
</html>